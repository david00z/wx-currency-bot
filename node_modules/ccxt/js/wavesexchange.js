...
module.exports = class wavesexchange extends Exchange {
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
        ...
        if (matcherFeeAssetId === undefined) {
            throw new InsufficientFunds (this.id + ' not enough funds on none of the eligible asset fees(недостаточно средств ни для одной из приемлемых комиссий за активы)');
        }
        amount = this.amountToPrecision (symbol, amount);
        price = this.priceToPrecision (symbol, price);
        const byteArray = [
